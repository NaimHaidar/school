...
<div>
    ...
    <div class="home-container">
        <header data-thq="thq-navbar" class="home-navbar-interactive">
            ...
            <?php
$connection = mysqli_connect("localhost", "root", "", "code labs");
if(empty($_GET['post_id'])) {
    $post_id = 2;
    $query = "SELECT * FROM posts WHERE post_id='$post_id'";
    $res = mysqli_query($connection, $query);
    $arr = mysqli_fetch_assoc($res);
    $query_2 = "SELECT * FROM users WHERE user_id='".$arr['user_id']."'";
    $res2 = mysqli_query($connection, $query_2);
    $arr2 =mysqli_fetch_assoc($res2);
    echo"<div class=\"qa_container\">
            <div class=\"col1\">
                <div class=\"userimg\"><img
                        src=\"$arr2[profile_pic]\"
                        alt=\"\" srcset=\"\"></i>
                </div>
                <div class=\"vote\">
                ...
                <div class=\"infobar cdw\">
                    <div class=\"name\"><a href=\"profile.php?post_id=\">$arr2[username]</a></div>
                    <div class=\"date\">Asked : $arr[date]</div>
                </div>
                <div class='heading'>$arr[title]
                </div>
                 <div class=\"details\">
